...
public class BookOperationsTest {
    ...
    // Start of method testing for "Book.RemoveStock()" {
    @Test
    ...
    // } end of "Book.RemoveStock()" testing


    // Start of method testing for "Book.AddStock()" {
    @Test
    ...
    // } end of "Book.AddStock()" testing


    // Start of method testing for "Book.getPurchasedAmount()" {
    @Test
    ...
    // } end of "Book.getPurchasedAmount()" testing
    ...
    // Start of method testing for "Book.getSoldDatesQuantitiesDay()" {
    @Test
    ...
    // } end of "Book.getSoldDatesQuantitiesDay()" testing
    ...
    // Start of method testing for "Book.getBoughtDatesQuantitiesDay()" {
    @Test
    ...
    // } end of "Book.getBoughtDatesQuantitiesDay()" testing
    ...
    // Start of method testing for "Book.getTotalBooksSoldDay()" {
    @Test
    ...
    // } end of "Book.getTotalBooksSoldDay()" testing


    // Start of method testing for "Book.getTotalBooksSoldYear()" {
    @Test
    ...
    // } end of "Book.getTotalBooksSoldYear()" testing
