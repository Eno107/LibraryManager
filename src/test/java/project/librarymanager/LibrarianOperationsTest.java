...
public class LibrarianOperationsTest {
    ...
    // Start of method testing for "Librarian.removeDuplicatesSoldBooks()" {
    @Test
    ...
    // } end of "Librarian.removeDuplicatesSoldBooks()" testing
    ...
    // Start of method testing for "Librarian.moneyMadeInYear()" {
    @Test
    ...
    // } end of "Librarian.moneyMadeInYear()" testing
    ...
    // Start of method testing for "Librarian.checkEmail()" {
    @Test
    ...
    // } end of "Librarian.checkEmail()" testing
    ...
    // Start of method testing for "Manager.partOfLibrarian()" {
    @Test
    ...
    // Start of method testing for "Manager.getBackLibrarian()" {
    @Test
